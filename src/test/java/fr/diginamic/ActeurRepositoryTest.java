...
public class ActeurRepositoryTest {
	...
	private EntityManagerFactory emf = Persistence.createEntityManagerFactory("config_db");
	...
	public void testExtraireParRealisateurEntreAnnee() {
		TypedQuery<Acteur> query = em.createQuery("SELECT DISTINCT a FROM Acteur a JOIN a.roles r JOIN r.film f JOIN f.realisateurs rs WHERE rs.identite ='Ridley Scott' AND f.annee BETWEEN 2010 AND 2000 ", Acteur.class);
		List<Acteur> acteurs = query.getResultList();
